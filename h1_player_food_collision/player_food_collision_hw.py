...
# DO NOT MODIFY vector.py or testing.py when doing this assignment
# ========================================================================================
...
class Box:
    """base object for creating rectangles at posn, with width, height, clr, and vel"""
...
class Food:
    """this class has-a Box object in it, and makes Food objects that the Player eats"""
...
class Foods:
    """this class has a list of Food objects in it, which the Player eats"""
        ...
        while not finished:
            for event in pg.event.get():
                if event.type == pg.QUIT:
                    ...
                    if event.key == pg.K_x:
                        # teleport the Player to a random location if 'x' is pressed
                        self.player.posn = Vector(
                            randint(0, WINDOW_WIDTH - self.player.width),
                            randint(0, WINDOW_HEIGHT - self.player.height),
                        )
                    elif event.key in keys:
                        # changes Player vector if arrow keys pressed
                    ...
                    # makes a new Food object if mouse is clicked
